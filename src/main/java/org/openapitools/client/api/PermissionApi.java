...
public class PermissionApi {
     ...
     */
    @Deprecated
    public okhttp3.Call getPermissionsCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getPermissionsValidateBeforeCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
     ...
     */
    @Deprecated
    public ActionCollection getPermissions(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
     ...
     */
    @Deprecated
    public ApiResponse<ActionCollection> getPermissionsWithHttpInfo(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
     ...
     */
    @Deprecated
    public okhttp3.Call getPermissionsAsync(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback<ActionCollection> _callback) throws ApiException {
