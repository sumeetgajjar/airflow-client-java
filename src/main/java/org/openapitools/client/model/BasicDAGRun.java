...
public class BasicDAGRun {
  ...
  public BasicDAGRun runId(@javax.annotation.Nullable String runId) {
    this.runId = runId;
    return this;
  }
  ...
  public BasicDAGRun logicalDate(@javax.annotation.Nullable OffsetDateTime logicalDate) {
  ...
  public BasicDAGRun state(@javax.annotation.Nullable DagState state) {
    this.state = state;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("run_id", "dag_id", "logical_date", "start_date", "end_date", "data_interval_start", "data_interval_end", "state"));
