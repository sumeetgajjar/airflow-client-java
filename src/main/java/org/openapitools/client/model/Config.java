...
public class Config {
  ...
  public Config sections(@javax.annotation.Nullable List<ConfigSection> sections) {
  ...
  public void setSections(@javax.annotation.Nullable List<ConfigSection> sections) {
    this.sections = sections;
  }
