...
public class ConfigSection {
  ...
  public ConfigSection options(@javax.annotation.Nullable List<ConfigOption> options) {
  ...
  public void setOptions(@javax.annotation.Nullable List<ConfigOption> options) {
    this.options = options;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "options"));
