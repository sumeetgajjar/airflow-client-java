...
public class ConnectionCollection {
  ...
  public ConnectionCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public ConnectionCollection connections(@javax.annotation.Nullable List<ConnectionCollectionItem> connections) {
  ...
  public void setConnections(@javax.annotation.Nullable List<ConnectionCollectionItem> connections) {
    this.connections = connections;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "connections"));
