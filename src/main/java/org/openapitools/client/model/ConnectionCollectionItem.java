...
public class ConnectionCollectionItem {
  ...
  public ConnectionCollectionItem connectionId(@javax.annotation.Nullable String connectionId) {
  ...
  public ConnectionCollectionItem connType(@javax.annotation.Nullable String connType) {
  ...
  public ConnectionCollectionItem description(@javax.annotation.Nullable String description) {
  ...
  public ConnectionCollectionItem host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public ConnectionCollectionItem login(@javax.annotation.Nullable String login) {
    this.login = login;
    return this;
  }
  ...
  public ConnectionCollectionItem schema(@javax.annotation.Nullable String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public ConnectionCollectionItem port(@javax.annotation.Nullable Integer port) {
    this.port = port;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("connection_id", "conn_type", "description", "host", "login", "schema", "port"));
