...
public class CronExpression {
  ...
  public CronExpression type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public CronExpression value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("__type", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("__type", "value"));
  }
