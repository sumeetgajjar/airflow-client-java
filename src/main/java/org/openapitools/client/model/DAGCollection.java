...
public class DAGCollection {
  ...
  public DAGCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public DAGCollection dags(@javax.annotation.Nullable List<DAG> dags) {
    this.dags = dags;
    return this;
  }
  ...
  public void setDags(@javax.annotation.Nullable List<DAG> dags) {
    this.dags = dags;
  }
