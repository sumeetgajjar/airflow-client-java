...
public class DatasetCollection {
  ...
  public DatasetCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public DatasetCollection datasets(@javax.annotation.Nullable List<Dataset> datasets) {
