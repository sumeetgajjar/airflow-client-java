...
public class EventLogCollection {
  ...
  public EventLogCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public EventLogCollection eventLogs(@javax.annotation.Nullable List<EventLog> eventLogs) {
  ...
  public void setEventLogs(@javax.annotation.Nullable List<EventLog> eventLogs) {
    this.eventLogs = eventLogs;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "event_logs"));
