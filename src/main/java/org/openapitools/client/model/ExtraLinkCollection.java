...
public class ExtraLinkCollection {
  ...
  public ExtraLinkCollection extraLinks(@javax.annotation.Nullable List<ExtraLink> extraLinks) {
  ...
  public void setExtraLinks(@javax.annotation.Nullable List<ExtraLink> extraLinks) {
    this.extraLinks = extraLinks;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("extra_links"));
