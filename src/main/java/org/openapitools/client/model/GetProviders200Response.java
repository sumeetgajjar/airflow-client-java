...
public class GetProviders200Response {
  ...
  public GetProviders200Response providers(@javax.annotation.Nullable List<Provider> providers) {
  ...
  public GetProviders200Response totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("providers", "total_entries"));
