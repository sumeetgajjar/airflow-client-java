...
public class ListDagRunsForm {
  ...
  public ListDagRunsForm orderBy(@javax.annotation.Nullable String orderBy) {
  ...
  public ListDagRunsForm pageOffset(@javax.annotation.Nullable Integer pageOffset) {
  ...
  public ListDagRunsForm pageLimit(@javax.annotation.Nullable Integer pageLimit) {
  ...
  public ListDagRunsForm dagIds(@javax.annotation.Nullable List<String> dagIds) {
    this.dagIds = dagIds;
    return this;
  }
  ...
  public ListDagRunsForm states(@javax.annotation.Nullable List<String> states) {
    this.states = states;
    return this;
  }
  ...
  public ListDagRunsForm executionDateGte(@javax.annotation.Nullable OffsetDateTime executionDateGte) {
  ...
  public ListDagRunsForm executionDateLte(@javax.annotation.Nullable OffsetDateTime executionDateLte) {
  ...
  public ListDagRunsForm startDateGte(@javax.annotation.Nullable OffsetDateTime startDateGte) {
  ...
  public ListDagRunsForm startDateLte(@javax.annotation.Nullable OffsetDateTime startDateLte) {
  ...
  public ListDagRunsForm endDateGte(@javax.annotation.Nullable OffsetDateTime endDateGte) {
  ...
  public ListDagRunsForm endDateLte(@javax.annotation.Nullable OffsetDateTime endDateLte) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("order_by", "page_offset", "page_limit", "dag_ids", "states", "execution_date_gte", "execution_date_lte", "start_date_gte", "start_date_lte", "end_date_gte", "end_date_lte"));
