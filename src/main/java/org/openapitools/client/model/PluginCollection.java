...
public class PluginCollection {
  ...
  public PluginCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public PluginCollection plugins(@javax.annotation.Nullable List<PluginCollectionItem> plugins) {
  ...
  public void setPlugins(@javax.annotation.Nullable List<PluginCollectionItem> plugins) {
    this.plugins = plugins;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "plugins"));
