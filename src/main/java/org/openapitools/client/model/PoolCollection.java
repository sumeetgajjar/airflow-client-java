...
public class PoolCollection {
  ...
  public PoolCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public PoolCollection pools(@javax.annotation.Nullable List<Pool> pools) {
    this.pools = pools;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "pools"));
