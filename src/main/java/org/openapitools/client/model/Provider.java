...
public class Provider {
  ...
  public Provider packageName(@javax.annotation.Nullable String packageName) {
  ...
  public Provider version(@javax.annotation.Nullable String version) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("package_name", "description", "version"));
