...
public class Role {
  ...
  public Role actions(@javax.annotation.Nullable List<ActionResource> actions) {
  ...
  public void setActions(@javax.annotation.Nullable List<ActionResource> actions) {
    this.actions = actions;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "actions"));
