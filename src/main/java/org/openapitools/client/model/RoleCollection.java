...
public class RoleCollection {
  ...
  public RoleCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public RoleCollection roles(@javax.annotation.Nullable List<Role> roles) {
    this.roles = roles;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "roles"));
