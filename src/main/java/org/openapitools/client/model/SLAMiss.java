...
public class SLAMiss {
  ...
  public SLAMiss dagId(@javax.annotation.Nullable String dagId) {
    this.dagId = dagId;
    return this;
  }
  ...
  public SLAMiss executionDate(@javax.annotation.Nullable String executionDate) {
  ...
  public SLAMiss emailSent(@javax.annotation.Nullable Boolean emailSent) {
  ...
  public void setEmailSent(@javax.annotation.Nullable Boolean emailSent) {
    this.emailSent = emailSent;
  }


  public SLAMiss timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public SLAMiss description(@javax.annotation.Nullable String description) {
  ...
  public SLAMiss notificationSent(@javax.annotation.Nullable Boolean notificationSent) {
  ...
  public void setNotificationSent(@javax.annotation.Nullable Boolean notificationSent) {
    this.notificationSent = notificationSent;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("task_id", "dag_id", "execution_date", "email_sent", "timestamp", "description", "notification_sent"));
