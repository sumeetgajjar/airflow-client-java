...
public class TaskInstanceCollection {
  ...
  public TaskInstanceCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public TaskInstanceCollection taskInstances(@javax.annotation.Nullable List<TaskInstance> taskInstances) {
  ...
  public void setTaskInstances(@javax.annotation.Nullable List<TaskInstance> taskInstances) {
    this.taskInstances = taskInstances;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "task_instances"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaskInstanceCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaskInstanceCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaskInstanceCollection is not found in the empty JSON string", TaskInstanceCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaskInstanceCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskInstanceCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("task_instances") != null && !jsonObj.get("task_instances").isJsonNull()) {
        ...
        if (jsonArraytaskInstances != null) {
          ...
          for (int i = 0; i < jsonArraytaskInstances.size(); i++) {
            TaskInstance.validateJsonElement(jsonArraytaskInstances.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaskInstanceCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaskInstanceCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaskInstanceCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaskInstanceCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<TaskInstanceCollection>() {
           @Override
           public void write(JsonWriter out, TaskInstanceCollection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaskInstanceCollection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaskInstanceCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaskInstanceCollection
   * @throws IOException if the JSON string is invalid with respect to TaskInstanceCollection
   */
  public static TaskInstanceCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaskInstanceCollection.class);
  }

  /**
   * Convert an instance of TaskInstanceCollection to an JSON string
   *
   * @return JSON string
   */
