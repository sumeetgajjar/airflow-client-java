...
public class TaskInstanceHistory {
  ...
  public TaskInstanceHistory taskId(@javax.annotation.Nullable String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public TaskInstanceHistory taskDisplayName(@javax.annotation.Nullable String taskDisplayName) {
  ...
  public TaskInstanceHistory dagId(@javax.annotation.Nullable String dagId) {
    this.dagId = dagId;
    return this;
  }
  ...
  public TaskInstanceHistory dagRunId(@javax.annotation.Nullable String dagRunId) {
  ...
  public TaskInstanceHistory startDate(@javax.annotation.Nullable String startDate) {
  ...
  public TaskInstanceHistory endDate(@javax.annotation.Nullable String endDate) {
  ...
  public TaskInstanceHistory duration(@javax.annotation.Nullable BigDecimal duration) {
  ...
  public TaskInstanceHistory state(@javax.annotation.Nullable TaskState state) {
    this.state = state;
    return this;
  }
  ...
  public TaskInstanceHistory tryNumber(@javax.annotation.Nullable Integer tryNumber) {
  ...
  public TaskInstanceHistory mapIndex(@javax.annotation.Nullable Integer mapIndex) {
  ...
  public TaskInstanceHistory maxTries(@javax.annotation.Nullable Integer maxTries) {
  ...
  public TaskInstanceHistory hostname(@javax.annotation.Nullable String hostname) {
  ...
  public TaskInstanceHistory unixname(@javax.annotation.Nullable String unixname) {
  ...
  public TaskInstanceHistory pool(@javax.annotation.Nullable String pool) {
    this.pool = pool;
    return this;
  }
  ...
  public TaskInstanceHistory poolSlots(@javax.annotation.Nullable Integer poolSlots) {
  ...
  public TaskInstanceHistory queue(@javax.annotation.Nullable String queue) {
    this.queue = queue;
    return this;
  }
  ...
  public TaskInstanceHistory priorityWeight(@javax.annotation.Nullable Integer priorityWeight) {
  ...
  public TaskInstanceHistory operator(@javax.annotation.Nullable String operator) {
  ...
  public TaskInstanceHistory queuedWhen(@javax.annotation.Nullable String queuedWhen) {
  ...
  public TaskInstanceHistory pid(@javax.annotation.Nullable Integer pid) {
    this.pid = pid;
    return this;
  }
  ...
  public TaskInstanceHistory executor(@javax.annotation.Nullable String executor) {
  ...
  public TaskInstanceHistory executorConfig(@javax.annotation.Nullable String executorConfig) {
  ...
  public boolean equals(Object o) {
    ...
    TaskInstanceHistory taskInstanceHistory = (TaskInstanceHistory) o;
    return Objects.equals(this.taskId, taskInstanceHistory.taskId) &&
        Objects.equals(this.taskDisplayName, taskInstanceHistory.taskDisplayName) &&
        Objects.equals(this.dagId, taskInstanceHistory.dagId) &&
        Objects.equals(this.dagRunId, taskInstanceHistory.dagRunId) &&
        Objects.equals(this.startDate, taskInstanceHistory.startDate) &&
        Objects.equals(this.endDate, taskInstanceHistory.endDate) &&
        Objects.equals(this.duration, taskInstanceHistory.duration) &&
        Objects.equals(this.state, taskInstanceHistory.state) &&
        Objects.equals(this.tryNumber, taskInstanceHistory.tryNumber) &&
        Objects.equals(this.mapIndex, taskInstanceHistory.mapIndex) &&
        Objects.equals(this.maxTries, taskInstanceHistory.maxTries) &&
        Objects.equals(this.hostname, taskInstanceHistory.hostname) &&
        Objects.equals(this.unixname, taskInstanceHistory.unixname) &&
        Objects.equals(this.pool, taskInstanceHistory.pool) &&
        Objects.equals(this.poolSlots, taskInstanceHistory.poolSlots) &&
        Objects.equals(this.queue, taskInstanceHistory.queue) &&
        Objects.equals(this.priorityWeight, taskInstanceHistory.priorityWeight) &&
        Objects.equals(this.operator, taskInstanceHistory.operator) &&
        Objects.equals(this.queuedWhen, taskInstanceHistory.queuedWhen) &&
        Objects.equals(this.pid, taskInstanceHistory.pid) &&
        Objects.equals(this.executor, taskInstanceHistory.executor) &&
        Objects.equals(this.executorConfig, taskInstanceHistory.executorConfig);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskId, taskDisplayName, dagId, dagRunId, startDate, endDate, duration, state, tryNumber, mapIndex, maxTries, hostname, unixname, pool, poolSlots, queue, priorityWeight, operator, queuedWhen, pid, executor, executorConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaskInstanceHistory {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("task_id", "task_display_name", "dag_id", "dag_run_id", "start_date", "end_date", "duration", "state", "try_number", "map_index", "max_tries", "hostname", "unixname", "pool", "pool_slots", "queue", "priority_weight", "operator", "queued_when", "pid", "executor", "executor_config"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaskInstanceHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaskInstanceHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaskInstanceHistory is not found in the empty JSON string", TaskInstanceHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaskInstanceHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskInstanceHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaskInstanceHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaskInstanceHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaskInstanceHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaskInstanceHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<TaskInstanceHistory>() {
           @Override
           public void write(JsonWriter out, TaskInstanceHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaskInstanceHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaskInstanceHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaskInstanceHistory
   * @throws IOException if the JSON string is invalid with respect to TaskInstanceHistory
   */
  public static TaskInstanceHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaskInstanceHistory.class);
  }

  /**
   * Convert an instance of TaskInstanceHistory to an JSON string
   *
   * @return JSON string
   */
