...
public class TaskOutletDatasetReference {
  ...
  public TaskOutletDatasetReference dagId(@javax.annotation.Nullable String dagId) {
    this.dagId = dagId;
    return this;
  }
  ...
  public TaskOutletDatasetReference taskId(@javax.annotation.Nullable String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public TaskOutletDatasetReference createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public TaskOutletDatasetReference updatedAt(@javax.annotation.Nullable String updatedAt) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("dag_id", "task_id", "created_at", "updated_at"));
