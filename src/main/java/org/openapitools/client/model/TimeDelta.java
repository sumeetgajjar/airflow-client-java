...
public class TimeDelta {
  ...
  public TimeDelta type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public TimeDelta days(@javax.annotation.Nonnull Integer days) {
    this.days = days;
    return this;
  }
  ...
  public TimeDelta seconds(@javax.annotation.Nonnull Integer seconds) {
  ...
  public TimeDelta microseconds(@javax.annotation.Nonnull Integer microseconds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("__type", "days", "seconds", "microseconds"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("__type", "days", "seconds", "microseconds"));
  }
