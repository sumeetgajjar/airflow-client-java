...
public class Trigger {
  ...
  public Trigger id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Trigger classpath(@javax.annotation.Nullable String classpath) {
  ...
  public void setClasspath(@javax.annotation.Nullable String classpath) {
    this.classpath = classpath;
  }


  public Trigger kwargs(@javax.annotation.Nullable String kwargs) {
    this.kwargs = kwargs;
    return this;
  }
  ...
  public void setKwargs(@javax.annotation.Nullable String kwargs) {
    this.kwargs = kwargs;
  }


  public Trigger createdDate(@javax.annotation.Nullable String createdDate) {
  ...
  public Trigger triggererId(@javax.annotation.Nullable Integer triggererId) {
  ...
  public void setTriggererId(@javax.annotation.Nullable Integer triggererId) {
    this.triggererId = triggererId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, trigger.id) &&
        Objects.equals(this.classpath, trigger.classpath) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, classpath, kwargs, createdDate, triggererId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "classpath", "kwargs", "created_date", "triggerer_id"));
