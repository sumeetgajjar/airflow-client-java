 ...
 */
@JsonAdapter(UpdateTaskState.Adapter.class)
public enum UpdateTaskState {
  ...
  public static UpdateTaskState fromValue(String value) {
    for (UpdateTaskState b : UpdateTaskState.values()) {
  ...
  public static class Adapter extends TypeAdapter<UpdateTaskState> {
    @Override
    public void write(final JsonWriter jsonWriter, final UpdateTaskState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UpdateTaskState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UpdateTaskState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UpdateTaskState.fromValue(value);
  }
}
