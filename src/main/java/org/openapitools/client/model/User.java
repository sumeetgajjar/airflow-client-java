...
public class User {
  ...
  public User roles(@javax.annotation.Nullable List<UserCollectionItemRolesInner> roles) {
    this.roles = roles;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("first_name", "last_name", "username", "email", "active", "last_login", "login_count", "failed_login_count", "roles", "created_on", "changed_on", "password"));
