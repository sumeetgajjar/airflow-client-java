...
public class UserCollection {
  ...
  public UserCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public UserCollection users(@javax.annotation.Nullable List<UserCollectionItem> users) {
    this.users = users;
    return this;
  }
  ...
  public void setUsers(@javax.annotation.Nullable List<UserCollectionItem> users) {
    this.users = users;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "users"));
