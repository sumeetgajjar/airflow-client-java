...
public class Variable {
  ...
  public Variable key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public Variable description(@javax.annotation.Nullable String description) {
  ...
  public Variable value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, description, value);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "description", "value"));
