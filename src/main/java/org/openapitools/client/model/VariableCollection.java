...
public class VariableCollection {
  ...
  public VariableCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public VariableCollection variables(@javax.annotation.Nullable List<VariableCollectionItem> variables) {
  ...
  public void setVariables(@javax.annotation.Nullable List<VariableCollectionItem> variables) {
    this.variables = variables;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "variables"));
