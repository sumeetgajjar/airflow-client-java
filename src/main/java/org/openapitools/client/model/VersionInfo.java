...
public class VersionInfo {
  ...
  public VersionInfo gitVersion(@javax.annotation.Nullable String gitVersion) {
  ...
  public void setGitVersion(@javax.annotation.Nullable String gitVersion) {
    this.gitVersion = gitVersion;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("version", "git_version"));
