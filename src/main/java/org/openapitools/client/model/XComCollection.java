...
public class XComCollection {
  ...
  public XComCollection totalEntries(@javax.annotation.Nullable Integer totalEntries) {
  ...
  public XComCollection xcomEntries(@javax.annotation.Nullable List<XComCollectionItem> xcomEntries) {
  ...
  public void setXcomEntries(@javax.annotation.Nullable List<XComCollectionItem> xcomEntries) {
    this.xcomEntries = xcomEntries;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total_entries", "xcom_entries"));
