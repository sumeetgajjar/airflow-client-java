...
public class XComCollectionItem {
  ...
  public XComCollectionItem key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public XComCollectionItem timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public XComCollectionItem executionDate(@javax.annotation.Nullable String executionDate) {
  ...
  public XComCollectionItem mapIndex(@javax.annotation.Nullable Integer mapIndex) {
  ...
  public XComCollectionItem taskId(@javax.annotation.Nullable String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public XComCollectionItem dagId(@javax.annotation.Nullable String dagId) {
    this.dagId = dagId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, xcomCollectionItem.key) &&
        ...
        Objects.equals(this.mapIndex, xcomCollectionItem.mapIndex) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, timestamp, executionDate, mapIndex, taskId, dagId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("key", "timestamp", "execution_date", "map_index", "task_id", "dag_id"));
