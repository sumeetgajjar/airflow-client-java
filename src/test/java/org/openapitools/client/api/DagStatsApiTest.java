...
/**
 * API tests for DagStatsApi
 */
@Disabled
public class DagStatsApiTest {

    private final DagStatsApi api = new DagStatsApi();
     ...
     */
    @Test
    public void getDagStatsTest() throws ApiException {
        String dagIds = null;
        DagStatsCollectionSchema response = api.getDagStats(dagIds);
