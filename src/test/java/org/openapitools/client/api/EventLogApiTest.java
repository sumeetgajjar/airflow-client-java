...
public class EventLogApiTest {
    ...
    public void getEventLogsTest() throws ApiException {
        ...
        Integer tryNumber = null;
        String event = null;
        String owner = null;
        OffsetDateTime before = null;
        OffsetDateTime after = null;
        String includedEvents = null;
        String excludedEvents = null;
        EventLogCollection response = api.getEventLogs(limit, offset, orderBy, dagId, taskId, runId, mapIndex, tryNumber, event, owner, before, after, includedEvents, excludedEvents);
        // TODO: test validations
    }
