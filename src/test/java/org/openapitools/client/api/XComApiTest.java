...
public class XComApiTest {
    ...
    public void getXcomEntriesTest() throws ApiException {
        ...
        Integer limit = null;
        Integer offset = null;
        XComCollection response = api.getXcomEntries(dagId, dagRunId, taskId, mapIndex, xcomKey, limit, offset);
    ...
    public void getXcomEntryTest() throws ApiException {
        ...
        Boolean stringify = null;
        XCom response = api.getXcomEntry(dagId, dagRunId, taskId, xcomKey, mapIndex, deserialize, stringify);
        // TODO: test validations
    }
